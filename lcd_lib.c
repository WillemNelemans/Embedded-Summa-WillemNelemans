...
uint8_t Temp_PORT;
	...
	//4 bit part
	Temp_PORT=LDP;
	LDP=((Temp_PORT & (1<<LCD_D3))|(ch&0b11110000));
	LCP|=1<<LCD_RS;
	LCP|=1<<LCD_E;		
	_delay_ms(1);
	LCP&=~(1<<LCD_E);	
	...
	_delay_ms(1);
	Temp_PORT=LDP;
	LDP=((Temp_PORT & (1<<LCD_D3))|((ch&0b00001111)<<4));
	LCP|=1<<LCD_RS;
	LCP|=1<<LCD_E;		
	_delay_ms(1);
	LCP&=~(1<<LCD_E);	
...
uint8_t Temp_PORT;
	...
	//LDP=(cmd&0b11110000);
	Temp_PORT=LDP;
	LDP=((Temp_PORT & (1<<LCD_D3))|(cmd&0b11110000));	
	LCP|=1<<LCD_E;		
	_delay_ms(1);
	LCP&=~(1<<LCD_E);
	_delay_ms(1);
	...
	Temp_PORT=LDP;
	LDP=((Temp_PORT & (1<<LCD_D3))|((cmd&0b00001111)<<4));
	LCP|=1<<LCD_E;		
	_delay_ms(1);
	LCP&=~(1<<LCD_E);
	_delay_ms(1);
...
uint8_t Temp_PORT;
	...
	//LCP=0x00;
	Temp_PORT=LDP;
	LDP=((Temp_PORT & (1<<LCD_D3))|0x00);
	Temp_PORT=LCP;
	LCP=((Temp_PORT & (1<<LCD_D3))|0x00);
	LDDR|=1<<LCD_D7|1<<LCD_D6|1<<LCD_D5|1<<LCD_D4;
	LCDR|=1<<LCD_E|1<<LCD_RW|1<<LCD_RS;
   //---------one------
	//LDP=0<<LCD_D7|0<<LCD_D6|1<<LCD_D5|1<<LCD_D4; //4 bit mode
	Temp_PORT=LDP;
	LDP=((Temp_PORT & (1<<LCD_D3))|(0<<LCD_D7|0<<LCD_D6|1<<LCD_D5|1<<LCD_D4));//4 bit mode
	...
	//LDP=0<<LCD_D7|0<<LCD_D6|1<<LCD_D5|1<<LCD_D4; //4 bit mode
	Temp_PORT=LCP;
	LCP=((Temp_PORT & (1<<LCD_D3))|(0<<LCD_D7|0<<LCD_D6|1<<LCD_D5|1<<LCD_D4));//4 bit mode
	LCP|=1<<LCD_E|0<<LCD_RW|0<<LCD_RS;		
	_delay_ms(1);
	LCP&=~(1<<LCD_E);
	_delay_ms(1);
	...
	Temp_PORT=LCP;
	LCP=((Temp_PORT & (1<<LCD_D3))|(0<<LCD_D7|0<<LCD_D6|1<<LCD_D5|0<<LCD_D4));//4 bit mode
	LCP|=1<<LCD_E|0<<LCD_RW|0<<LCD_RS;		
	_delay_ms(1);
	LCP&=~(1<<LCD_E);
	_delay_ms(1);
